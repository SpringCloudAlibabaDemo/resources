...
CREATE TABLE `rocketmq_transaction_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'RocketMQ事务日志表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of rocketmq_transaction_log
-- ----------------------------
INSERT INTO `rocketmq_transaction_log` VALUES (1, '335ec91f-5868-464c-96c1-cf8605febba5', '审核分享');
...
CREATE TABLE `share`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分享表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of share
-- ----------------------------
INSERT INTO `share` VALUES (1, 4, 'springcloud', '2020-01-19 14:45:10', '2020-01-19 14:45:12', 0, '杨浩', '', '', 0, '', 0, 0, 'PASS', '这秀的资源');
INSERT INTO `share` VALUES (2, 2, 'java', '2020-01-19 14:46:07', '2020-01-19 14:46:09', 0, 'hna', '', '', 0, '', 0, 0, 'NOT_YET', '');
INSERT INTO `share` VALUES (3, 3, 'html', '2020-01-19 14:46:26', '2020-01-19 14:46:29', 0, 'sdaf', '', '', 0, '', 0, 0, 'NOT_YET', '');
